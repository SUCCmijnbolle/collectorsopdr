...
<head>
    ...
    <link rel="stylesheet" href="../../css/inlog/createaccount.css">
    <link rel="stylesheet" href="../../css/inlog/inlog.css">    
    <title>Create Account</title>
    </head>
    <body>
    <img src="../../img/RPSD_logopng.png" alt="picture"> 
    <div id="page">
        <div id="container">
            ...
            ?>
            <div class="noacc"><h3><a href="../../inlog.php" style="text-decoration: none;">Inloggen</a></h3> </div>
        </div>
    </div>
