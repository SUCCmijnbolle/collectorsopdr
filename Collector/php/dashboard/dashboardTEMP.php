...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO `users`(`image`) VALUES ('$data[1]','$data[2]',$data[3])";
    try{
...
<html>
    ...
    <body>
        <form action="php_insert_update_delete_search.php" method="post">
            <input type="number" name="users" placeholder="users" value="<?php echo $users;?>"><br><br>
            <input type="text" name="image" placeholder="images" value="<?php echo $images;?>"> <br><br>
            <div>
